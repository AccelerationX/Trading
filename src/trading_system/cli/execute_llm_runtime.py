...
def execute_llm_runtime(
    ...
    *,
    ...
    routes = _apply_route_limit(routes, limit=limit, include_remote_providers=include_remote_providers)
    json_path, md_path, records = execute_llm_runtime_with_inputs(trade_date, packets, routes)
