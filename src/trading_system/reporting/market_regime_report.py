...
def render_market_regime_markdown(snapshot: MarketRegimeSnapshot) -> str:
    lines = [
        ...
        f"- index_trend_state: `{snapshot.index_trend_state}`",
        f"- index_alignment: `{snapshot.index_alignment}`",
        f"- trend_strength_score: `{snapshot.trend_strength_score}`",
        ...
        f"- speculative_heat_score: `{snapshot.speculative_heat_score}`",
        f"- sentiment_pressure_score: `{snapshot.sentiment_pressure_score}`",
        f"- breakout_failure_rate: `{snapshot.breakout_failure_rate}`",
